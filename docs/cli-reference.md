...
| `AGENT_SCAN_BIN` | Optional Agent Scan executable. The session-start discovery hook is installed only when this is set, and its trampoline invokes only this path. |
